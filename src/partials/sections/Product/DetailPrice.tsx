function DetailPrice() {
  return (
    <div className="bg-white text-black px-4 py-16 md:px-8">
      ...
      <div className="grid grid-cols-2 gap-4 mt-4 font-bold text-xl md:text-2xl">
        <div className="border border-black p-4 bg-black text-white">
          <span className="block">$FORGE Price</span>
          <span className="block md:text-5xl">$0.09</span>
        </div>
        <div className="border border-black p-4">
          <span className="block">24h Price Change</span>
          <span className="block md:text-5xl">-0.173%</span>
        </div>
        <div className="border border-black p-4">
          <span className="block">Fully Diluted valuation</span>
          <span className="block md:text-5xl">$4,127,304</span>
        </div>
        <div className="border border-black p-4">
          <span className="block">Total Volume</span>
          <span className="block md:text-5xl">11,937.7SOL</span>
        </div>
      </div>
    </div>
  );
