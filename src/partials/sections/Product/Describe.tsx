...
const Describe = React.forwardRef(
      ...
      <div className="container-center" id="describe-products" ref={ref}>
        <div className="px-4 py-12 font-bold md:px-8 md:py-20 md:mt-16">
          ...
          <div className="md:text-2xl lg:text-3xl ">
            <p>
              When you see the Built by Blocksmith Labs label, you can trust
              that you are getting a product of the highest quality. From a
              whitelist management platform to dynamic art generation, our team
              has developed solutions to address a variety of real-world
              problems within Web3.
            </p>
          </div>
        </div>
      </div>
